...
HD_PWD='C:/Users/Surface/Documents/GitHub/NJUST-Integrated-Design-of-Digital-System-ES_design/ES_design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_progress.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_progress.tcl -notrace
