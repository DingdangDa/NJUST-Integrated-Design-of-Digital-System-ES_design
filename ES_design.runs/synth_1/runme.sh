...
HD_PWD='C:/Users/Surface/Documents/GitHub/NJUST-Integrated-Design-of-Digital-System-ES_design/ES_design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_progress.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_progress.tcl
