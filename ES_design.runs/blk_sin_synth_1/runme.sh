...
HD_PWD='C:/Users/Surface/Documents/GitHub/NJUST-Integrated-Design-of-Digital-System-ES_design/ES_design.runs/blk_sin_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_sin.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_sin.tcl
